...
<head>
    ...
    <title>Profil</title>
    <link rel="stylesheet" href="all-profil-ustadz.css">
</head>
                        ...
                        <div class="part-one">
                            ...
                            <div>
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="GET">
                                    <div class="check">
                                        <div>
                                            <select name="idUstadz">
                                                <?php
                                                $sql = "SELECT idUstadz, fullName FROM tb_ustadz";
                                                $hasil = mysqli_query($koneksi, $sql);
                                                while ($data = mysqli_fetch_array($hasil)) {
                                                    $ket = "";
                                                    if (isset($_GET['idUstadz'])) {
                                                        $idUstadz = trim($_GET['idUstadz']);
                                                        if ($idUstadz == $data['idUstadz']) {
                                                            $ket = "selected";
                                                        }
                                                    }
                                                ?>
                                ...
                                if (isset($_GET['idUstadz'])) {
                                    ...
                                    $sql = "SELECT * FROM tb_ustadz WHERE idUstadz=$idUstadz";
                                    $hasil = mysqli_query($koneksi, $sql);
